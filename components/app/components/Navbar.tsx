...
import LogoImg from '@/public/bridge-black-bg.svg'
            ...
            <nav className="max-w-full w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
                <div className="flex items-center justify-between w-full">
                    <div className="flex items-center">
                        <div className="sm:hidden">
                            <Sheet>
                                ...
                                <SheetContent side={"left"} className="w-[300px] sm:w-[340px]">
                                    <SheetHeader>
                                        <SheetTitle className='text-left text-2xl font-mono font-bold ml-3'>Bridge</SheetTitle>
                                        <SheetDescription>
                                            <SidebarMenu />
                                        </SheetDescription>
                                    </SheetHeader>
                        ...
                        <a className="flex-none text-2xl ml-4 font-mono font-semibold text-white" href="/dashboard">
                            Bridge
                        </a>
                    </div>
                    <div className="flex items-center">
