...
// make it generic so teams can use it or small scale companies
// make it flexible so that it can be used for various number of industries
// integrate it with gen ai for better suggestions and reporting
function Home() {
  return (
